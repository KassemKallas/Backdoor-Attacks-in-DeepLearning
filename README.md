...
- [Surveys on Backdoor attacks and defenses](#surveys-on-backdoor-attacks-and-defenses)
  * [2022](#2022)
          + [1. A Survey of Neural Trojan Attacks and Defenses in Deep Learning [Paper](https://arxiv.org/pdf/2202.07183)](#1-a-survey-of-neural-trojan-attacks-and-defenses-in-deep-learning--paper--https---arxivorg-pdf-220207183-)
  * [2021](#2021)
          + [1. An Overview of Backdoor Attacks Against Deep Neural Networks and Possible Defences [Paper](https://arxiv.org/pdf/2111.08429)](#1-an-overview-of-backdoor-attacks-against-deep-neural-networks-and-possible-defences--paper--https---arxivorg-pdf-211108429-)
          + [2. Artificial Intelligence Security: Threats and Countermeasures [Paper](https://dl.acm.org/doi/pdf/10.1145/3487890)](#2-artificial-intelligence-security--threats-and-countermeasures--paper--https---dlacmorg-doi-pdf-101145-3487890-)
          + [3. Security Meets Deep Learning [PhD Dissertation](https://search.proquest.com/openview/b52f04da04e5213385f37eb6ec00cae8/1?pq-origsite=gscholar&cbl=18750&diss=y)](#3-security-meets-deep-learning--phd-dissertation--https---searchproquestcom-openview-b52f04da04e5213385f37eb6ec00cae8-1-pq-origsite-gscholar-cbl-18750-diss-y-)
  * [2020](#2020)
          + [1. Machine learning security: Threats, countermeasures, and evaluations [Paper](https://ieeexplore.ieee.org/iel7/6287639/8948470/09064510.pdf)](#1-machine-learning-security--threats--countermeasures--and-evaluations--paper--https---ieeexploreieeeorg-iel7-6287639-8948470-09064510pdf-)
          + [2. A survey on neural trojans [Paper](https://ieeexplore.ieee.org/iel7/9131689/9136966/09137011.pdf)](#2-a-survey-on-neural-trojans--paper--https---ieeexploreieeeorg-iel7-9131689-9136966-09137011pdf-)
          + [3. Backdoor attacks and countermeasures on deep learning: A comprehensive review [Paper](https://ieeexplore.ieee.org/iel7/9131689/9136966/09137011.pdf)](#3-backdoor-attacks-and-countermeasures-on-deep-learning--a-comprehensive-review--paper--https---ieeexploreieeeorg-iel7-9131689-9136966-09137011pdf-)
          + [4. Deep learning backdoors [Paper](https://arxiv.org/pdf/2007.08273.pdf?ref=https://githubhelp.com)](#4-deep-learning-backdoors--paper--https---arxivorg-pdf-200708273pdf-ref-https---githubhelpcom-)
          + [5. Backdoor learning: A survey [Paper](https://arxiv.org/pdf/2007.08745)](#5-backdoor-learning--a-survey--paper--https---arxivorg-pdf-200708745-)
- [Available sources and toolboxes](#available-sources-and-toolboxes)
- [Backdoor Attacks](#backdoor-attacks)
  * [2022](#2022-1)
          + [1. Label-Smoothed Backdoor Attack [Paper](https://arxiv.org/pdf/2202.11203)](#1-label-smoothed-backdoor-attack--paper--https---arxivorg-pdf-220211203-)
  * [2021](#2021-1)
          + [1. WaNet--Imperceptible Warping-based Backdoor Attack [Paper](https://arxiv.org/pdf/2102.10369)](#1-wanet--imperceptible-warping-based-backdoor-attack--paper--https---arxivorg-pdf-210210369-)
          + [2. LIRA: Learnable, Imperceptible and Robust Backdoor Attacks [Paper](http://openaccess.thecvf.com/content/ICCV2021/papers/Doan_LIRA_Learnable_Imperceptible_and_Robust_Backdoor_Attacks_ICCV_2021_paper.pdf)](#2-lira--learnable--imperceptible-and-robust-backdoor-attacks--paper--http---openaccessthecvfcom-content-iccv2021-papers-doan-lira-learnable-imperceptible-and-robust-backdoor-attacks-iccv-2021-paperpdf-)
          + [3. Invisible poison: A blackbox clean label backdoor attack to deep neural networks [Paper](https://ieeexplore.ieee.org/iel7/9488422/9488423/09488902.pdf)](#3-invisible-poison--a-blackbox-clean-label-backdoor-attack-to-deep-neural-networks--paper--https---ieeexploreieeeorg-iel7-9488422-9488423-09488902pdf-)
          + [4. Check your other door! establishing backdoor attacks in the frequency domain [Paper](https://arxiv.org/pdf/2109.05507)](#4-check-your-other-door--establishing-backdoor-attacks-in-the-frequency-domain--paper--https---arxivorg-pdf-210905507-)
          + [5. Use Procedural Noise to Achieve Backdoor Attack [Paper](https://ieeexplore.ieee.org/iel7/6287639/9312710/09529206.pdf)](#5-use-procedural-noise-to-achieve-backdoor-attack--paper--https---ieeexploreieeeorg-iel7-6287639-9312710-09529206pdf-)
          + [6. Poison Ink: Robust and Invisible Backdoor Attack [Paper](https://arxiv.org/pdf/2108.02488)](#6-poison-ink--robust-and-invisible-backdoor-attack--paper--https---arxivorg-pdf-210802488-)
          + [7. AdvDoor: adversarial backdoor attack of deep learning system [Paper](https://dl.acm.org/doi/pdf/10.1145/3460319.3464809)](#7-advdoor--adversarial-backdoor-attack-of-deep-learning-system--paper--https---dlacmorg-doi-pdf-101145-34603193464809-)
          + [8. Backdoor attack in the physical world [Paper](https://arxiv.org/pdf/2104.02361)](#8-backdoor-attack-in-the-physical-world--paper--https---arxivorg-pdf-210402361-)
          + [9. Defense-resistant backdoor attacks against deep neural networks in outsourced cloud environment [Paper](https://ieeexplore.ieee.org/iel7/49/9486979/09450029.pdf)](#9-defense-resistant-backdoor-attacks-against-deep-neural-networks-in-outsourced-cloud-environment--paper--https---ieeexploreieeeorg-iel7-49-9486979-09450029pdf-)
          + [10. Deep feature space trojan attack of neural networks by controlled detoxification [Paper](https://ojs.aaai.org/index.php/AAAI/article/view/16201/16008)](#10-deep-feature-space-trojan-attack-of-neural-networks-by-controlled-detoxification--paper--https---ojsaaaiorg-indexphp-aaai-article-view-16201-16008-)
          + [11. A Master Key backdoor for universal impersonation attack against DNN-based face verification [Paper](https://www.sciencedirect.com/science/article/pii/S0167865521000210)](#11-a-master-key-backdoor-for-universal-impersonation-attack-against-dnn-based-face-verification--paper--https---wwwsciencedirectcom-science-article-pii-s0167865521000210-)
          + [12. DeepPoison: Feature Transfer Based Stealthy Poisoning Attack for DNNs [Paper](https://ieeexplore.ieee.org/iel7/8920/4358609/09359658.pdf)](#12-deeppoison--feature-transfer-based-stealthy-poisoning-attack-for-dnns--paper--https---ieeexploreieeeorg-iel7-8920-4358609-09359658pdf-)
  * [2020](#2020-1)
          + [1. Reflection backdoor: A natural backdoor attack on deep neural networks [Paper](https://arxiv.org/pdf/2007.02343.pdf?ref=https://githubhelp.com)](#1-reflection-backdoor--a-natural-backdoor-attack-on-deep-neural-networks--paper--https---arxivorg-pdf-200702343pdf-ref-https---githubhelpcom-)
          + [2. Systematic Evaluation of Backdoor Data Poisoning Attacks on Image Classifiers [Paper](http://openaccess.thecvf.com/content_CVPRW_2020/papers/w47/Truong_Systematic_Evaluation_of_Backdoor_Data_Poisoning_Attacks_on_Image_Classifiers_CVPRW_2020_paper.pdf)](#2-systematic-evaluation-of-backdoor-data-poisoning-attacks-on-image-classifiers--paper--http---openaccessthecvfcom-content-cvprw-2020-papers-w47-truong-systematic-evaluation-of-backdoor-data-poisoning-attacks-on-image-classifiers-cvprw-2020-paperpdf-)
          + [3. One-to-N & N-to-one: Two advanced backdoor attacks against deep learning models [Paper](https://ieeexplore.ieee.org/iel7/8858/4358699/09211729.pdf)](#3-one-to-n---n-to-one--two-advanced-backdoor-attacks-against-deep-learning-models--paper--https---ieeexploreieeeorg-iel7-8858-4358699-09211729pdf-)
          + [4. Backdooring convolutional neural networks via targeted weight perturbations [Paper](https://ieeexplore.ieee.org/iel7/9304574/9304852/09304875.pdf)](#4-backdooring-convolutional-neural-networks-via-targeted-weight-perturbations--paper--https---ieeexploreieeeorg-iel7-9304574-9304852-09304875pdf-)
          + [5. Live Trojan Attacks on Deep Neural Networks [Paper](http://openaccess.thecvf.com/content_CVPRW_2020/papers/w47/Costales_Live_Trojan_Attacks_on_Deep_Neural_Networks_CVPRW_2020_paper.pdf)](#5-live-trojan-attacks-on-deep-neural-networks--paper--http---openaccessthecvfcom-content-cvprw-2020-papers-w47-costales-live-trojan-attacks-on-deep-neural-networks-cvprw-2020-paperpdf-)
          + [6. Topic branch Invisible backdoor attacks on deep neural networks via steganography and regularization [Paper](https://ieeexplore.ieee.org/iel7/8858/4358699/09186317.pdf)](#6-topic-branch-invisible-backdoor-attacks-on-deep-neural-networks-via-steganography-and-regularization--paper--https---ieeexploreieeeorg-iel7-8858-4358699-09186317pdf-)
          + [7. Backdooring and poisoning neural networks with image-scaling attacks [Paper](https://ieeexplore.ieee.org/iel7/9283745/9283819/09283824.pdf)](#7-backdooring-and-poisoning-neural-networks-with-image-scaling-attacks--paper--https---ieeexploreieeeorg-iel7-9283745-9283819-09283824pdf-)
          + [8. Bypassing backdoor detection algorithms in deep learning [Paper](https://ieeexplore.ieee.org/iel7/9229479/9230353/09230390.pdf)](#8-bypassing-backdoor-detection-algorithms-in-deep-learning--paper--https---ieeexploreieeeorg-iel7-9229479-9230353-09230390pdf-)
          + [9. Composite backdoor attack for deep neural network by mixing existing benign features [Paper](https://dl.acm.org/doi/pdf/10.1145/3372297.3423362)](#9-composite-backdoor-attack-for-deep-neural-network-by-mixing-existing-benign-features--paper--https---dlacmorg-doi-pdf-101145-33722973423362-)
          + [10. Hidden trigger backdoor attacks [Paper](https://ojs.aaai.org/index.php/AAAI/article/download/6871/6725)](#10-hidden-trigger-backdoor-attacks--paper--https---ojsaaaiorg-indexphp-aaai-article-download-6871-6725-)
          + [11. Clean-label backdoor attacks on video recognition models [Paper](http://openaccess.thecvf.com/content_CVPR_2020/papers/Zhao_Clean-Label_Backdoor_Attacks_on_Video_Recognition_Models_CVPR_2020_paper.pdf)](#11-clean-label-backdoor-attacks-on-video-recognition-models--paper--http---openaccessthecvfcom-content-cvpr-2020-papers-zhao-clean-label-backdoor-attacks-on-video-recognition-models-cvpr-2020-paperpdf-)
  * [2019](#2019)
          + [1. Luminance-based video backdoor attack against anti-spoofing rebroadcast detection [Paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8901711)](#1-luminance-based-video-backdoor-attack-against-anti-spoofing-rebroadcast-detection--paper--https---ieeexploreieeeorg-stamp-stampjsp-tp--arnumber-8901711-)
          + [2. badnets: Evaluating backdooring attacks on deep neural networks [Paper](https://ieeexplore.ieee.org/iel7/6287639/8600701/08685687.pdf)](#2-badnets--evaluating-backdooring-attacks-on-deep-neural-networks--paper--https---ieeexploreieeeorg-iel7-6287639-8600701-08685687pdf-)
          + [3. Latent backdoor attacks on deep neural networks [Paper](https://dl.acm.org/doi/pdf/10.1145/3319535.3354209)](#3-latent-backdoor-attacks-on-deep-neural-networks--paper--https---dlacmorg-doi-pdf-101145-33195353354209-)
          + [4. Transferable clean-label poisoning attacks on deep neural nets [Paper](http://proceedings.mlr.press/v97/zhu19a/zhu19a.pdf)](#4-transferable-clean-label-poisoning-attacks-on-deep-neural-nets--paper--http---proceedingsmlrpress-v97-zhu19a-zhu19apdf-)
          + [5. Label-consistent backdoor attacks [Paper](https://arxiv.org/pdf/1912.02771/)](#5-label-consistent-backdoor-attacks--paper--https---arxivorg-pdf-191202771--)
  * [2018](#2018)
          + [1. Poison frogs! targeted clean-label poisoning attacks on neural networks [Paper](https://proceedings.neurips.cc/paper/2018/file/22722a343513ed45f14905eb07621686-Paper.pdf)](#1-poison-frogs--targeted-clean-label-poisoning-attacks-on-neural-networks--paper--https---proceedingsneuripscc-paper-2018-file-22722a343513ed45f14905eb07621686-paperpdf-)
          + [2. Are you tampering with my data? [Paper](http://openaccess.thecvf.com/content_ECCVW_2018/papers/11130/Alberti_Are_You_Tampering_With_My_Data_ECCVW_2018_paper.pdf)](#2-are-you-tampering-with-my-data---paper--http---openaccessthecvfcom-content-eccvw-2018-papers-11130-alberti-are-you-tampering-with-my-data-eccvw-2018-paperpdf-)
  * [2017](#2017)
          + [1. Neural  trojans [Paper](https://ieeexplore.ieee.org/iel7/8118206/8119172/08119189.pdf)](#1-neural--trojans--paper--https---ieeexploreieeeorg-iel7-8118206-8119172-08119189pdf-)
          + [2. Targeted  backdoor attacks on deep learning systems using data poisoning [Paper](https://arxiv.org/pdf/1712.05526.pdf?ref=https://githubhelp.com)](#2-targeted--backdoor-attacks-on-deep-learning-systems-using-data-poisoning--paper--https---arxivorg-pdf-171205526pdf-ref-https---githubhelpcom-)
          + [3. Universal adversarial perturbations [Paper](http://openaccess.thecvf.com/content_cvpr_2017/papers/Moosavi-Dezfooli_Universal_Adversarial_Perturbations_CVPR_2017_paper.pdf)](#3-universal-adversarial-perturbations--paper--http---openaccessthecvfcom-content-cvpr-2017-papers-moosavi-dezfooli-universal-adversarial-perturbations-cvpr-2017-paperpdf-)
          + [4. Trojaning attack on neural networks [Paper](https://docs.lib.purdue.edu/cgi/viewcontent.cgi?article=2782&context=cstech)](#4-trojaning-attack-on-neural-networks--paper--https---docslibpurdueedu-cgi-viewcontentcgi-article-2782-context-cstech-)
- [Backdoor Defenses](#backdoor-defenses)
  * [2022](#2022-2)
          + [1. Adversarial Fine-tuning for Backdoor Defense: Connect Adversarial Examples to Triggered Samples [Paper](https://arxiv.org/pdf/2202.06312)](#1-adversarial-fine-tuning-for-backdoor-defense--connect-adversarial-examples-to-triggered-samples--paper--https---arxivorg-pdf-220206312-)
  * [2021](#2021-2)
          + [1. Neural attention distillation: Erasing backdoor triggers from deep neural networks [Paper](https://arxiv.org/pdf/2101.05930.pdf?ref=https://githubhelp.com)](#1-neural-attention-distillation--erasing-backdoor-triggers-from-deep-neural-networks--paper--https---arxivorg-pdf-210105930pdf-ref-https---githubhelpcom-)
          + [2. Adversarial neuron pruning purifies backdoored deep models [Paper](https://proceedings.neurips.cc/paper/2021/file/8cbe9ce23f42628c98f80fa0fac8b19a-Paper.pdf)](#2-adversarial-neuron-pruning-purifies-backdoored-deep-models--paper--https---proceedingsneuripscc-paper-2021-file-8cbe9ce23f42628c98f80fa0fac8b19a-paperpdf-)
          + [3. Detecting Backdoor in Deep Neural Networks via Intentional Adversarial Perturbations [Paper](https://arxiv.org/pdf/2105.14259)](#3-detecting-backdoor-in-deep-neural-networks-via-intentional-adversarial-perturbations--paper--https---arxivorg-pdf-210514259-)
          + [4. Boundary augment: A data augment method to defend poison attack [Paper](https://scholar.google.com/scholar?output=instlink&q=info:5o_b0ZSyIFgJ:scholar.google.com/&hl=en&as_sdt=2005&sciodt=0,5&as_ylo=2021&as_yhi=2021&scillfp=2463025849653391467&oi=lle)](#4-boundary-augment--a-data-augment-method-to-defend-poison-attack--paper--https---scholargooglecom-scholar-output-instlink-q-info-5o-b0zsyifgj-scholargooglecom--hl-en-as-sdt-2005-sciodt-0-5-as-ylo-2021-as-yhi-2021-scillfp-2463025849653391467-oi-lle-)
          + [5. Deepsweep: An evaluation framework for mitigating dnn backdoor attacks using data augmentation [Paper](https://dl.acm.org/doi/pdf/10.1145/3433210.3453108)](#5-deepsweep--an-evaluation-framework-for-mitigating-dnn-backdoor-attacks-using-data-augmentation--paper--https---dlacmorg-doi-pdf-101145-34332103453108-)
          + [6. Detecting scene-plausible perceptible backdoors in trained dnns without access to the training set [Paper](https://scholar.google.com/scholar?output=instlink&q=info:TEVmgXii7iQJ:scholar.google.com/&hl=en&as_sdt=0,5&scillfp=9902495154299535680&oi=lle)](#6-detecting-scene-plausible-perceptible-backdoors-in-trained-dnns-without-access-to-the-training-set--paper--https---scholargooglecom-scholar-output-instlink-q-info-tevmgxii7iqj-scholargooglecom--hl-en-as-sdt-0-5-scillfp-9902495154299535680-oi-lle-)
          + [7. Detecting ai trojans using meta neural analysis [Paper](https://ieeexplore.ieee.org/iel7/9519381/9519382/09519467.pdf)](#7-detecting-ai-trojans-using-meta-neural-analysis--paper--https---ieeexploreieeeorg-iel7-9519381-9519382-09519467pdf-)
          + [8. Demon in the Variant: Statistical Analysis of {DNNs} for Robust Backdoor Contamination Detection [Paper](https://www.usenix.org/system/files/sec21-tang-di.pdf)](#8-demon-in-the-variant--statistical-analysis-of--dnns--for-robust-backdoor-contamination-detection--paper--https---wwwusenixorg-system-files-sec21-tang-dipdf-)
          + [9. De-pois: An attack-agnostic defense against data poisoning attacks [Paper](https://ieeexplore.ieee.org/iel7/10206/4358835/09431105.pdf)](#9-de-pois--an-attack-agnostic-defense-against-data-poisoning-attacks--paper--https---ieeexploreieeeorg-iel7-10206-4358835-09431105pdf-)
  * [2020](#2020-2)
          + [1. Sentinet: Detecting localized universal attacks against deep learning systems [Paper](https://ieeexplore.ieee.org/iel7/9283745/9283819/09283822.pdf)](#1-sentinet--detecting-localized-universal-attacks-against-deep-learning-systems--paper--https---ieeexploreieeeorg-iel7-9283745-9283819-09283822pdf-)
          + [2. Februus: Input purification defense against trojan attacks on deep neural network systems [Paper](https://dl.acm.org/doi/pdf/10.1145/3427228.3427264)](#2-februus--input-purification-defense-against-trojan-attacks-on-deep-neural-network-systems--paper--https---dlacmorg-doi-pdf-101145-34272283427264-)
          + [3. Backdoor suppression in neural networks using input fuzzing and majority voting [Paper](https://ieeexplore.ieee.org/iel7/6221038/6461917/08963957.pdf)](#3-backdoor-suppression-in-neural-networks-using-input-fuzzing-and-majority-voting--paper--https---ieeexploreieeeorg-iel7-6221038-6461917-08963957pdf-)
          + [4. Detecting backdoor attacks via class difference in deep neural networks [Paper](https://ieeexplore.ieee.org/iel7/6287639/8948470/09233317.pdf)](#4-detecting-backdoor-attacks-via-class-difference-in-deep-neural-networks--paper--https---ieeexploreieeeorg-iel7-6287639-8948470-09233317pdf-)
          + [5. Detecting Backdoors in Neural Networks Using Novel Feature-Based Anomaly Detection [Paper](https://arxiv.org/pdf/2011.02526)](#5-detecting-backdoors-in-neural-networks-using-novel-feature-based-anomaly-detection--paper--https---arxivorg-pdf-201102526-)
          + [6. NNoculation: Broad spectrum and targeted treatment of backdoored DNNs [Paper](https://arxiv.org/pdf/2002.08313)](#6-nnoculation--broad-spectrum-and-targeted-treatment-of-backdoored-dnns--paper--https---arxivorg-pdf-200208313-)
          + [7. Confoc: Content-focus protection against trojan attacks on neural networks [Paper](https://arxiv.org/pdf/2007.00711)](#7-confoc--content-focus-protection-against-trojan-attacks-on-neural-networks--paper--https---arxivorg-pdf-200700711-)
          + [8. Systematic evaluation of backdoor data poisoning attacks on image classifiers [Paper](http://openaccess.thecvf.com/content_CVPRW_2020/papers/w47/Truong_Systematic_Evaluation_of_Backdoor_Data_Poisoning_Attacks_on_Image_Classifiers_CVPRW_2020_paper.pdf)](#8-systematic-evaluation-of-backdoor-data-poisoning-attacks-on-image-classifiers--paper--http---openaccessthecvfcom-content-cvprw-2020-papers-w47-truong-systematic-evaluation-of-backdoor-data-poisoning-attacks-on-image-classifiers-cvprw-2020-paperpdf-)
          + [9. Detection of backdoors in trained classifiers without access to the training set [Paper](https://ieeexplore.ieee.org/iel7/5962385/6104215/09296553.pdf)](#9-detection-of-backdoors-in-trained-classifiers-without-access-to-the-training-set--paper--https---ieeexploreieeeorg-iel7-5962385-6104215-09296553pdf-)
          + [10. Gangsweep: Sweep out neural backdoors by gan [Paper](https://dl.acm.org/doi/pdf/10.1145/3394171.3413546)](#10-gangsweep--sweep-out-neural-backdoors-by-gan--paper--https---dlacmorg-doi-pdf-101145-33941713413546-)
          + [11. Universal litmus patterns: Revealing backdoor attacks in cnns [Paper](http://openaccess.thecvf.com/content_CVPR_2020/papers/Kolouri_Universal_Litmus_Patterns_Revealing_Backdoor_Attacks_in_CNNs_CVPR_2020_paper.pdf)](#11-universal-litmus-patterns--revealing-backdoor-attacks-in-cnns--paper--http---openaccessthecvfcom-content-cvpr-2020-papers-kolouri-universal-litmus-patterns-revealing-backdoor-attacks-in-cnns-cvpr-2020-paperpdf-)
          + [12. Exposing backdoors in robust machine learning models [Paper](https://arxiv.org/pdf/2003.00865.pdf?ref=https://githubhelp.com)](#12-exposing-backdoors-in-robust-machine-learning-models--paper--https---arxivorg-pdf-200300865pdf-ref-https---githubhelpcom-)
          + [13. Deep k-NN Defense Against Clean-Label Data Poisoning Attacks [Paper](https://arxiv.org/pdf/1909.13374)](#13-deep-k-nn-defense-against-clean-label-data-poisoning-attacks--paper--https---arxivorg-pdf-190913374-)
          + [14. Robust anomaly detection and backdoor attack detection via differential privacy [Paper](https://arxiv.org/pdf/1911.07116.pdf?ref=https://githubhelp.com)](#14-robust-anomaly-detection-and-backdoor-attack-detection-via-differential-privacy--paper--https---arxivorg-pdf-191107116pdf-ref-https---githubhelpcom-)
          + [15. Disabling backdoor and identifying poison data by using knowledge distillation in backdoor attacks on deep neural networks [Paper](https://dl.acm.org/doi/pdf/10.1145/3411508.3421375)](#15-disabling-backdoor-and-identifying-poison-data-by-using-knowledge-distillation-in-backdoor-attacks-on-deep-neural-networks--paper--https---dlacmorg-doi-pdf-101145-34115083421375-)
  * [2019](#2019-1)
          + [1. Neural cleanse: Identifying and mitigating backdoor attacks in neural networks [Paper](https://ieeexplore.ieee.org/iel7/8826229/8835208/08835365.pdf)](#1-neural-cleanse--identifying-and-mitigating-backdoor-attacks-in-neural-networks--paper--https---ieeexploreieeeorg-iel7-8826229-8835208-08835365pdf-)
          + [2. Strip: A defence against trojan attacks on deep neural networks [Paper](https://dl.acm.org/doi/pdf/10.1145/3359789.3359790)](#2-strip--a-defence-against-trojan-attacks-on-deep-neural-networks--paper--https---dlacmorg-doi-pdf-101145-33597893359790-)
          + [3. Tabor: A highly accurate approach to inspecting and restoring trojan backdoors in ai systems [Paper](https://arxiv.org/pdf/1908.01763.pdf?ref=https://githubhelp.com)](#3-tabor--a-highly-accurate-approach-to-inspecting-and-restoring-trojan-backdoors-in-ai-systems--paper--https---arxivorg-pdf-190801763pdf-ref-https---githubhelpcom-)
          + [4. Abs: Scanning neural networks for back-doors by artificial brain stimulation [Paper](https://dl.acm.org/doi/pdf/10.1145/3319535.3363216?ref=https://githubhelp.com)](#4-abs--scanning-neural-networks-for-back-doors-by-artificial-brain-stimulation--paper--https---dlacmorg-doi-pdf-101145-33195353363216-ref-https---githubhelpcom-)
          + [5. DeepInspect: A Black-box Trojan Detection and Mitigation Framework for Deep Neural Networks [Paper](http://www.aceslab.org/sites/default/files/DeepInspect.pdf)](#5-deepinspect--a-black-box-trojan-detection-and-mitigation-framework-for-deep-neural-networks--paper--http---wwwaceslaborg-sites-default-files-deepinspectpdf-)
          + [6. Defending neural backdoors via generative distribution modeling [Paper](https://proceedings.neurips.cc/paper/2019/file/78211247db84d96acf4e00092a7fba80-Paper.pdf)](#6-defending-neural-backdoors-via-generative-distribution-modeling--paper--https---proceedingsneuripscc-paper-2019-file-78211247db84d96acf4e00092a7fba80-paperpdf-)
          + [7. A benchmark study of backdoor data poisoning defenses for deep neural network classifiers and a novel defense [Paper](https://ieeexplore.ieee.org/iel7/8911118/8918685/08918908.pdf)](#7-a-benchmark-study-of-backdoor-data-poisoning-defenses-for-deep-neural-network-classifiers-and-a-novel-defense--paper--https---ieeexploreieeeorg-iel7-8911118-8918685-08918908pdf-)
  * [2018](#2018-1)
          + [1. Fine-pruning: Defending against backdooring attacks on deep neural networks [Paper](https://arxiv.org/pdf/1805.12185)](#1-fine-pruning--defending-against-backdooring-attacks-on-deep-neural-networks--paper--https---arxivorg-pdf-180512185-)
  * [2017](#2017-1)
          + [1. Neural trojans [Paper](https://ieeexplore.ieee.org/iel7/8118206/8119172/08119189.pdf)](#1-neural-trojans--paper--https---ieeexploreieeeorg-iel7-8118206-8119172-08119189pdf-)
